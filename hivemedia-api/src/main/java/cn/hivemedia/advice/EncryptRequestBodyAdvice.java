package cn.hivemedia.advice;

import cn.hivemedia.annotation.Decrypt;
import cn.hivemedia.auto.EncryptProperties;
import cn.hivemedia.common.utils.AesEncryptUtils;
...
/**
 * @author ZengXiong
 * @Description 请求数据接收处理类, 对加了@Decrypt的方法的数据进行解密操作,只对@RequestBody参数有效
